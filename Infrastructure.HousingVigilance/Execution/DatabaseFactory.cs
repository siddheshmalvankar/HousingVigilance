...
namespace Infrastructure.HousingVigilance.Execution
{
    public class DatabaseFactory : IDatabaseFactory
    {
        ...
        {
            _context.Database.e
            var connection = (SqlConnection)_context.Database.S .. .G .AsSqlServer().Connection.DbConnection;
            ...
            if (timeout.HasValue)
            {
                ...
                previousTimeout = _context.CommandTimeout;
            ...
            if (!hasOutputParameters)
            {
                ...
                var result = _context.ExecuteStoreQuery<TResult>(commandText, parameters).ToList();
                if (timeout.HasValue)
                {
                    // Set previous timeout back
                    _context.CommandTimeout = previousTimeout;
                }
